            ...
            {items.length > 0 && (
              <div className="p-6 border-t border-gray-100 bg-gray-50/50">
                ...
                <button 
                  ...
                  className="w-full bg-gray-900 text-white py-4 rounded-xl font-bold flex items-center justify-center gap-2 hover:bg-black transition-colors shadow-lg shadow-gray-900/10"
                >
                  Finalizar Compra
                  <ArrowRight size={18} />
                </button>
