    ...
    return (
      <div className="min-h-screen bg-slate-50 flex flex-col items-center justify-center p-6">
        <div className="text-center space-y-4">
          ...
          <h2 className="text-2xl font-bold text-gray-900">O carrinho está vazio</h2>
          <button onClick={() => navigate('/loja')} className="text-primary-600 font-bold hover:underline">
            Voltar à Loja
          </button>
        </div>
      </div>
    ...
    return (
      <div className="min-h-screen bg-slate-50 flex items-center justify-center p-6 pt-32">
        ...
        >
          ...
          <h2 className="text-3xl font-bold text-gray-900 mb-4">Pedido Registado!</h2>
  ...
  return (
    <div className="min-h-screen bg-slate-50 pt-32 pb-24">
      <div className="container mx-auto px-6">
        ...
        <h1 className="text-4xl font-bold text-gray-900 mb-12">Finalizar Encomenda</h1>
        ...
        <div className="grid lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-7">
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div className="bg-white rounded-3xl p-8 shadow-sm border border-gray-100">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="md:col-span-2">
                    ...
                    <input required type="text" className="w-full bg-gray-50 border-transparent focus:bg-white focus:border-primary-500 rounded-xl px-4 py-3 outline-none transition-all" />
                  </div>
                  <div className="md:col-span-2">
                    <label className="block text-xs font-bold text-gray-400 uppercase tracking-wider mb-2">Email</label>
                    <input required type="email" className="w-full bg-gray-50 border-transparent focus:bg-white focus:border-primary-500 rounded-xl px-4 py-3 outline-none transition-all" />
                  </div>
                  <div className="md:col-span-2">
                    <label className="block text-xs font-bold text-gray-400 uppercase tracking-wider mb-2">Telefone</label>
                    <input required type="tel" className="w-full bg-gray-50 border-transparent focus:bg-white focus:border-primary-500 rounded-xl px-4 py-3 outline-none transition-all" />
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-3xl p-8 shadow-sm border border-gray-100">
                <h3 className="text-xl font-bold text-gray-900 mb-6 flex items-center gap-2">
                  <Landmark className="text-primary-500" />
              ...
              <button 
                type="submit"
                disabled={loading}
                className="w-full bg-gray-900 text-white py-5 rounded-2xl font-bold hover:bg-black transition-all shadow-xl shadow-gray-900/20 flex items-center justify-center gap-3 text-lg"
              >
                Confirmar Encomenda
              </button>
            </form>
          ...
          <div className="lg:col-span-5">
            <div className="bg-white rounded-3xl p-8 shadow-soft border border-gray-100 sticky top-32">
              ...
              <div className="mt-8 flex gap-3 text-xs text-gray-400 bg-gray-50 p-4 rounded-xl">
                <ShieldCheck className="shrink-0 text-gray-400" />
